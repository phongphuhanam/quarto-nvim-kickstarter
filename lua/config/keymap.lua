...
wk.add({
  {
    ...
    { '<leader>ao', group = 'Ollama Markdown Chat' },
    { '<leader>aoa', '<cmd>OllamaChat<cr>', desc = 'Ollama Ch[a]t' },
    { '<leader>aon', '<cmd>OllamaCreateNewChat<cr>', desc = 'Create Ollama [N]ew Chat' },
    { '<leader>aoo', '<cmd>OllamaContinueChat<cr>', desc = 'C[o]ntinue Ollama Chat' },
    { '<leader>aoq', ':OllamaQuickChat<cr>', desc = 'Ollama [Q]uick Chat' },
    ...
    },
    {
      ...
      desc = 'Spectre search current word on current [f]ile',
    },
